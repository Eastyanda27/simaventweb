<?php
    $n=16;
	$m=6;
	if (!function_exists('getFurniture'))
	{
		function getFurniture($n) {
	...
	if (!function_exists('getCategoryFurniture'))
	{
		function getCategoryFurniture($m) {
			$characters = '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ';
			$randomString = '';
...
@section("container")
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Aset Alat & Perabotan</h4>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="card">
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<form action="/perabotan" method="POST">
														@csrf
														<div class="row">
															<div class="col-sm-12">
															...
															<div class="col-sm-12">
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <input name="brand" id="brand" type="text" class="form-control @error('brand') is-invalid @enderror" placeholder="Isi Merk Barang" value="{{ old('brand') }}">
																	@error('brand')
																	<div class="invalid-feedback">
																		{{ $message }}
																	</div>
															...
															<div class="col-sm-12">
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <input name="type" id="type" type="text" class="form-control @error('type') is-invalid @enderror" placeholder="Isi Model Barang" value="{{ old('type') }}">
																	@error('type')
																	<div class="invalid-feedback">
																		{{ $message }}
																	</div>
															...
															<div class="col-sm-12">
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <input name="specification" id="specification" type="text" class="form-control @error('specification') is-invalid @enderror" placeholder="Isi Spesifikasi Barang" value="{{ old('specification') }}">
																	@error('specification')
																	<div class="invalid-feedback">
																		{{ $message }}
																	</div>
															...
															<div class="col-sm-12">
																<div class="form-group">
																	<input name="id_asset" id="id_asset" type="text" class="form-control @error('id_asset') is-invalid @enderror" placeholder="" value="<?php echo getFurniture($n) ?>" readonly hidden>
																	@error('id_asset')
																	<div class="invalid-feedback">
																		{{ $message }}
																	</div>
									...
									<div class="modal fade" id="addRowCategory" tabindex="-1" role="dialog"
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<form action="/kategoriperabotan" method="POST">
														@csrf
														<div class="row">
															<div class="col-sm-12">
																<div class="form-group form-group-default">
																	...
																	<select name="asset_category" id="asset_category" class="form-control @error('asset_category') @enderror" required>
																		<option value="">Pilih</option>
																		<option value="perabotan">Perabotan (Kursi, Meja, Piring, dll)</option>
																		<option value="alat">Alat (Palu, Obeng, Gergaji, dll)</option>
																	</select>
																	@error('asset_category')
																	<div class="invalid-feedback">
																		{{ $message }}
															...
															<div class="col-sm-12">
																<div class="form-group">
																	<input name="id_category" id="id_category" type="text" class="form-control @error('id_category') is-invalid @enderror" placeholder="" value="<?php echo getCategoryFurniture($m) ?>" readonly hidden>
																	@error('id_category')
																	<div class="invalid-feedback">
																		{{ $message }}
																	</div>
